        ...
        return (
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="none"
              stroke={active ? 'var(--play-blue)' : 'var(--text-secondary)'}
